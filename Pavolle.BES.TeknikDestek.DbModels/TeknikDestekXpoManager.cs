...
using Pavolle.BES.TeknikDestek.DbModels.Entities;
...
namespace Pavolle.BES.TeknikDestek.DbModels
{
    public class TeknikDestekXpoManager : Singleton<TeknikDestekXpoManager>
    {
        ...
        private TeknikDestekXpoManager()
        {
        }
