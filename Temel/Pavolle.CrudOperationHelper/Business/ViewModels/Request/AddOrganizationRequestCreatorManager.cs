...
{
    public class AddOrganizationRequestCreatorManager : Singleton<AddOrganizationRequestCreatorManager>, ICreatorManager
    {
        private AddOrganizationRequestCreatorManager()
        {
        ...
        public bool Write(string companyName, string projectName, string projectPath)
        {
            ...
            var creator = new RequestCreatorManager(companyName, projectName, projectPath, properties, "AddOrganizationRequest", projectName + "RequestBase");
