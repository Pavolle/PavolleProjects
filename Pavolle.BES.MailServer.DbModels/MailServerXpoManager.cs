...
using Pavolle.BES.MailServer.DbModels.Entities;
...
namespace Pavolle.BES.MailServer.DbModels
{
    public class MailServerXpoManager : Singleton<MailServerXpoManager>
    {
