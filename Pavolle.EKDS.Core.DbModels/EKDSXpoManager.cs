...
using Pavolle.EKDS.Core.DbModels.Entities;
using System;
...
namespace Pavolle.EKDS.Core.DbModels
{

    public class EKDSXpoManager : Singleton<EKDSXpoManager>
    {
