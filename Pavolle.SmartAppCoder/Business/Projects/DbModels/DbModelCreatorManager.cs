...
namespace Pavolle.SmartAppCoder.Business.Projects.DbModels
{
    public class DbModelCreatorManager
    {
        ...
        public DbModelCreatorManager(string companyName, string projectName, string projectPath, List<ColumnModel> columns, string className, string tableName)
        {
            ...
            DbClass += "using " + companyName + ".Core.Enums;" + Environment.NewLine;
            DbClass += "using " + ProjectNameRoot + ".Common.Enums;" + Environment.NewLine;
            DbClass += "" + Environment.NewLine;
            DbClass += Namespace;
            DbClass += "{" + Environment.NewLine;
            DbClass += "    [Persistent(\""+tableName+"\")]" + Environment.NewLine;
            DbClass += "    public class " + ClassName + " : BaseObject" + Environment.NewLine;
            DbClass += "    {" + Environment.NewLine;
