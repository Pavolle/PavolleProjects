...
{
    public class XpoManagerCreatorManager : Singleton<XpoManagerCreatorManager>
    {
        ...
        public bool Write(string companyName, string projectName, string projectPath)
        {
            ...
            xpoManagerClass += "using " + projectNameRoot + ".DbModels.Entities;" + Environment.NewLine;
            xpoManagerClass += "using Pavolle.Core.Utils;" + Environment.NewLine;
            xpoManagerClass += "" + Environment.NewLine;
            xpoManagerClass += "namespace " + projectNameRoot + ".DbModels.Manager" + Environment.NewLine;
            xpoManagerClass += "{" + Environment.NewLine;
            xpoManagerClass += "    public class XpoManager : Singleton<XpoManager>" + Environment.NewLine;
            xpoManagerClass += "    {" + Environment.NewLine;
            ...
            xpoManagerClass += "" + Environment.NewLine;
            xpoManagerClass += "        private XpoManager()" + Environment.NewLine;
            xpoManagerClass += "        {" + Environment.NewLine;
            xpoManagerClass += "        }" + Environment.NewLine;
            xpoManagerClass += "" + Environment.NewLine;
