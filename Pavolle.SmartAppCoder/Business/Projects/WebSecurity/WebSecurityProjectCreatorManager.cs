...
namespace Pavolle.CrudOperationHelper.Business.WebSecurity
{
    public class WebSecurityProjectCreatorManager : Singleton<WebSecurityProjectCreatorManager>
    {
        ...
        //    identityClass += "namespace " + projectNameRoot + ".WebSecurity" + Environment.NewLine;
        //    identityClass += "{" + Environment.NewLine;
        ...
        //    bool createResult = FileHelperManager.Instance.WriteFile(projectPath, projectNameRoot + ".WebSecurity, projectName + AppConsts.WebSecurityIdentityClassFileName, identityClass);
        //    #endregion
        ...
        //    principalClass += "namespace " + projectNameRoot + ".WebSecurity" + Environment.NewLine;
        //    principalClass += "{" + Environment.NewLine;
        ...
        //    jwtTokenManagerClass += "namespace " + projectNameRoot + ".WebSecurity" + Environment.NewLine;
        //    jwtTokenManagerClass += "{" + Environment.NewLine;
