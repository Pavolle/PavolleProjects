...
namespace Pavolle.SmartAppCoder.Business.Security.Symmetric
{
    internal class AESAlgorithmCreatorManager : Singleton<AESAlgorithmCreatorManager>
    {
        ...
        public bool Create(string projectPath, string organizationName)
        {
            ...
            classString += "{" + Environment.NewLine;
            classString += "    public class AESAlgorithm : ISymmetric" + Environment.NewLine;
            classString += "    {" + Environment.NewLine;
            ...
            classString += "            var provider = new AesCryptoServiceProvider();" + Environment.NewLine;
            ...
            classString += "    }" + Environment.NewLine;
            classString += "}" + Environment.NewLine;
            return FileHelperManager.Instance.WriteFile(projectPath + "\\" + organizationName + ".Security", "Symmetric", "AESAlgorithm.cs", classString);
        }
    }
}
