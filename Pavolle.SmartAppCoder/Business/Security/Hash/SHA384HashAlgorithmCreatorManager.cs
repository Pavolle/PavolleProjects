...
namespace Pavolle.SmartAppCoder.Business.Security.Hash
{
    internal class SHA384HashAlgorithmCreatorManager : Singleton<SHA384HashAlgorithmCreatorManager>
    {
        ...
        public bool Create(string projectPath, string organizationName)
        {
            ...
            classString += "{" + Environment.NewLine;
            classString += "    public class SHA384HashAlgorithm : AbstractHashAlgorithm" + Environment.NewLine;
            classString += "    {" + Environment.NewLine;
            ...
            classString += "            using (var provider = new SHA384CryptoServiceProvider())" + Environment.NewLine;
            classString += "            {" + Environment.NewLine;
            ...
            classString += "        {" + Environment.NewLine;
            classString += "            byte[] result;" + Environment.NewLine;
            classString += "            using (var provider = new HMACSHA384(password))" + Environment.NewLine;
            classString += "            {" + Environment.NewLine;
            classString += "                result = provider.ComputeHash(plaintext);" + Environment.NewLine;
            classString += "            }" + Environment.NewLine;
            classString += "            return result;" + Environment.NewLine;
            ...
            classString += "    }" + Environment.NewLine;
            classString += "}" + Environment.NewLine;
            return FileHelperManager.Instance.WriteFile(projectPath + "\\" + organizationName + ".Security", "Hash", "SHA384HashAlgorithm.cs", classString);
