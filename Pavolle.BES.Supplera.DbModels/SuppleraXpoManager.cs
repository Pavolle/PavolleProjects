...
using Pavolle.BES.Supplera.DbModels.Entities;
...
namespace Pavolle.BES.Supplera.DbModels
{
    public class SuppleraXpoManager : Singleton<SuppleraXpoManager>
    {
