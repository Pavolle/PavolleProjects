...
using Pavolle.BES.MembershipServer.DbModels.Entities;
using System;
...
namespace Pavolle.BES.MembershipServer.DbModels
{
    public class MembershipServerXpoManager : Singleton<MembershipServerXpoManager>
    {
        ...
        private MembershipServerXpoManager()
        {
        }
