...
using Pavolle.BES.NotificationServer.DbModels.Entities;
...
namespace Pavolle.BES.NotificationServer.DbModels
{

    public class NotificationServerXpoManager : Singleton<NotificationServerXpoManager>
    {
        ...
        private NotificationServerXpoManager()
        {
        }
